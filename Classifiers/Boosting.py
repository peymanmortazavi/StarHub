...
if __name__ == '__main__':
	...
	regr1 = GradientBoostingRegressor(n_estimators=500, learning_rate=0.01, max_depth=3, random_state=0)
	regr1.fit(X_train, Y_train)
	
	
	print mean_squared_error(Y_test, regr1.predict(X_test))
	
	feature_importance = regr1.feature_importances_*100
